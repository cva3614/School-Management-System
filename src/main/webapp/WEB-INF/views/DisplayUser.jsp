	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-head-line">Display User</h1>
										...
										<tbody>
											<c:forEach items="${du}" var="User">
												<tr>
													...
													<td>${User.status}</td>
													<td><a
														href="UserController?uid=${User.uid}&action=edit">Edit</a></td>
													<!--yesto direct do get ma jancha-->
													<td><a
														href="UserController?cid=${User.uid}&action=delete">Delete</a></td>
