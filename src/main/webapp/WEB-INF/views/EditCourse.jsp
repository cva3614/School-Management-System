			...
			<div id="page-inner">
				...
				<div class="row">
					<div class="col-md-12 col-sm-6 col-xs-12">
						<form role="form" action="CourseController" method="post">
							<div class="col-md-12 col-sm-6 col-xs-12">
								<div class="col-md-6 col-sm-6 col-xs-12">


									<div class="form-group">
										<label>Cid</label> <input class="form-control" type="text"
											name="cid" value="${ec.get(0).cid}">
									</div>
								</div>
							</div>
							<div class="col-md-12 col-sm-6 col-xs-12">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									...
									<div class="form-group">
										<label>Title</label> <input class="form-control" type="text"
											name="title" value="${ec.get(0).title}">
									</div>
									<div class="form-group">
										<label>Duration</label> <input class="form-control"
											type="text" name="duration" value="${ec.get(0).duration}">
									</div>
								</div>
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="form-group">
										<label>Price</label> <input class="form-control" type="text"
											name="price" value="${ec.get(0).price}">
									</div>
								</div>
